...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwimage05.png"),}),
    ...
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwinfoimage05.png"),}),
