...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwimage09.png"),}),
    ...
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwinfoimage09.png"),}),
    ...
    fontLoader.load("../../font/Do Hyeon_Regular.json", (font) => {
        const geometry = new TextGeometry("로봇\n청소기", {
            font: font,
            size: 11,
            height: 1,
        });
