...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwimage03.png"),}),
    ...
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwinfoimage03.png"),}),
    ...
    fontLoader.load("../../font/Do Hyeon_Regular.json", (font) => {
        const geometry = new TextGeometry("무인\n입출입\n관제시스템", {
            font: font,
            size: 9,
            height: 1,
        });
