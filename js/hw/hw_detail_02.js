...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwimage02.png"),}),
    ...
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/hw/hwinfoimage02.png"),}),
    ...
    fontLoader.load("../../font/Do Hyeon_Regular.json", (font) => {
        const geometry = new TextGeometry("포토\n다이오드\n탁도계", {
            font: font,
            size: 9,
            height: 1,
        });
